...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(!isConnected(LoginActivity.this)){
            Toast.makeText(LoginActivity.this,"No internet connection, Please turn on internet to Sign in", Toast.LENGTH_SHORT).show();
                ...
                if (FirebaseAuth.getInstance().getCurrentUser() != null) {
                    ...
                    rootRef.addListenerForSingleValueEvent(new ValueEventListener() {
                        ...
                        public void onCancelled(DatabaseError databaseError) {
                            Toast.makeText(LoginActivity.this, "Databse eroor", Toast.LENGTH_LONG).show();
                    ...
                    Toast.makeText(LoginActivity.this, "Click on Sign in to continue", Toast.LENGTH_LONG).show();
